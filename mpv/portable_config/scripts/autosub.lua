...
--          { '--legendastv', 'USERNAME', 'PASSWORD' },
            { '--opensubtitles', 'jidea', 'Heslo@blabla11' },
...
function download_subs(language)
    ...
    log('Hladam ' .. language[1] .. ' titulky ...', 30)
    ...
    if string.find(result.stdout, 'Downloaded 1 subtitle') then
        ...
        log(language[1] .. ' titulky stiahnute!')
        return true
    else
...
mp.add_key_binding('m', 'control_downloads2', control_downloads2)
